export default {
  ...
  'sessions.attentionFilter.toggle': '仅显示需要关注',
  ...
  'settings.display.attentionSessionsOnly': '仅显示需要关注',
  'settings.display.attentionSessionsOnly.desc': '仅显示有权限请求、等待输入或未读活动的会话；当前打开的会话仍会保留显示。',
