    ...
    return (
        <SettingsPageContent description={t('settings.display.description')}>
            ...
            <SettingsSection title={t('settings.display.sessions')}>
                ...
                <SettingsSwitch label={t('settings.display.attentionSessionsOnly')} description={t('settings.display.attentionSessionsOnly.desc')} checked={showAttentionSessionsOnly} onChange={setShowAttentionSessionsOnly} />
