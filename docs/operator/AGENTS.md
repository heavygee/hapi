...
| New behavior intake / peer spawn | Follow intake §0; **`hapi-spawn-peer`** (spawn+rename+ping+verify). Spawn HTTP ≠ handoff — extra JSON `message` is stripped | [`new-feature-intake.md`](../tooling/new-feature-intake.md); postmortem [`2026-08-11-spawn-peer-empty-shell-postmortem.md`](../plans/2026-08-11-spawn-peer-empty-shell-postmortem.md) |
