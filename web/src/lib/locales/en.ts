export default {
  ...
  'settings.display.pinInProgressSessions.desc': 'How loudly unpinned sessions float to the In progress section above project folders. Default is long-running jobs and urgent PR matters (outliving batch work with a session job meter, plus a fresh operator-hold chip). Quiet active agents stay in project folders unless you choose All activity. Global pins remain above it; project pins stay first inside their folders. Off keeps everything in directory groups.',
  'settings.display.pinInProgressMode.off': 'Off',
  'settings.display.pinInProgressMode.jobs': 'Long-running jobs and urgent PR matters',
