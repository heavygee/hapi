export default {
  ...
  'agentImport.tooltip': '从所选在线 runner 将代理会话导入 Hapi',
  ...
  'agentImport.hubLocalScopeHint': '通过 machine RPC 在在线 runner 上发现会话（与 Codex 相同）。需要至少一台在线机器。',
  ...
  'cursorSync.confirm.loading': '正在从 runner 加载 Cursor 聊天…',
  'cursorSync.confirm.empty': '所选 runner 上未找到 Cursor 聊天',
  'cursorSync.confirm.emptyForWorkdir': '所选 runner 该工作目录下没有 Cursor 聊天',
  ...
  'claudeSync.confirm.description': '从所选在线 runner 选择需要导入到 Hapi 的 Claude 会话',
  'claudeSync.confirm.selectAll': '全选',
  'claudeSync.confirm.clearAll': '全取消',
  'claudeSync.confirm.selectedCount': '已选择 {n} 个会话',
  'claudeSync.confirm.empty': '所选 runner 上未找到 Claude 会话',
  ...
  'claudeSync.confirm.emptyForWorkdir': '所选 runner 此工作目录下没有 Claude 会话',
  'claudeSync.confirm.confirm': '导入',
  'claudeSync.confirm.confirming': '导入中…',
  'claudeSync.confirm.loading': '正在从 runner 读取 Claude 会话…',
