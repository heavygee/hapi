export default {
  ...
  'agentImport.tooltip': 'Import agent sessions into Hapi from the selected online runner',
  ...
  'agentImport.hubLocalScopeHint': 'Discovery runs on an online runner via machine RPC (same path as Codex). Requires at least one online machine.',
  ...
  'cursorSync.confirm.loading': 'Loading Cursor chats from runner…',
  'cursorSync.confirm.empty': 'No Cursor chats found on the selected runner',
  'cursorSync.confirm.emptyForWorkdir': 'No Cursor chats in this workspace on the selected runner',
  ...
  'cursorSync.confirm.acpStrictHint': 'Imports run agent acp verify-probe on the runner before any Hapi row is created. Chats that fail are reported per-row with a reason; no partial state is left behind.',
  ...
  'claudeSync.confirm.description': 'Choose Claude sessions to import into Hapi from the selected online runner',
  ...
  'claudeSync.confirm.empty': 'No Claude sessions found on the selected runner',
  ...
  'claudeSync.confirm.emptyForWorkdir': 'No Claude sessions in this work directory on the selected runner',
  'claudeSync.confirm.confirm': 'Import',
  'claudeSync.confirm.confirming': 'Importing…',
  'claudeSync.confirm.loading': 'Loading Claude sessions from runner…',
