export default {
  ...
  'composerTerminal.fueTitle': 'New: Remote terminal',
  'composerTerminal.fueBody': 'Open a live terminal on the machine running this session — same shell you’d get over SSH.',
  'newSessionWorktree.fueTitle': 'New: Worktree sessions',
  'newSessionWorktree.fueBody': 'Creates a fresh git worktree next to your repo instead of using the directory as-is, so this session never touches your other branches.',
