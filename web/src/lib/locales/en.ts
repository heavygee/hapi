export default {
  ...
  'message.pin': 'Pin to Session Log',
  'message.unpin': 'Unpin from Session Log',
  'message.copy': 'Copy',
  ...
  'sessions.blockedChip.blocked': 'Blocked',
  'session.action.markUnblocked': 'Mark unblocked…',
  'sessions.unblock.title': 'Mark unblocked',
  'sessions.unblock.description': 'Replying to the agent records your reasoning in the transcript. Dismissing here does not, so give a reason — it goes in the event log the overseer reads.',
  'sessions.unblock.reasonLabel': 'Unblock reason',
  'sessions.unblock.placeholder': 'Why is this no longer blocked?',
  'sessions.unblock.reasonRequired': 'A reason is required.',
  'sessions.unblock.confirm': 'Mark unblocked',
  'sessions.unblock.preset.handled': 'Handled outside HAPI',
  'sessions.unblock.preset.notBlocked': 'Not actually blocked',
  'sessions.unblock.preset.abandoned': 'Abandoning this work',
  'sessions.unblock.preset.superseded': 'Superseded by other work',
  'sessions.blockedChip.stalled': 'Stalled',
  'sessions.blockedChip.permission': 'Permission',
  'sessions.blockedChip.decision': 'Decision',
  'sessions.blockedChip.review': 'Review',
  'sessions.blockedChip.failed': 'Failed',
  'sessions.blockedChip.question': 'Question',
  ...
  'session.time.weeksAgo': '{n}w ago',
  'session.time.monthsAgo': '{n}mo ago',
  'session.time.almostOneYearAgo': 'almost 1y ago',
  ...
  'session.log.filter.pinned': 'Pinned',
  'session.log.filterQuery': 'Filter summaries',
  'session.log.filterQueryPlaceholder': 'Filter summaries…',
  'session.log.emptyPinned': 'No pinned messages yet — use the pin control on a message',
  'session.log.emptyFilter': 'No summaries match this filter',
  ...
  'session.flow.activity': 'File activity',
  ...
  'newSession.type.worktree.desc': "Create a new worktree next to repo, so this session won't touch your other branches (Cursor uses native ~/.cursor/worktrees)",
  ...
  'fue.dontShowAgain': "Don't show tips like this again",
  'composerTerminal.fueTitle': 'Remote terminal',
  'composerTerminal.fueBody': 'Open a live terminal on the machine running this session — same shell you’d get over SSH.',
  'composerSettings.fueTitle': 'Session settings',
  'composerSettings.fueBody': 'Model, effort, permission mode, and other per-session options live here.',
  'composerSwitchRemote.fueTitle': 'Switch to remote control',
  'composerSwitchRemote.fueBody': 'Hand this session over to the web, so you can keep going from any device — not just this terminal.',
  'composerSchedule.fueTitle': 'Schedule for later',
  'composerSchedule.fueBody': 'Pick a time and HAPI sends this message for you — handy for off-hours nudges or batching work.',
  'composerVoiceStart.fueTitle': 'Talk instead of type',
  'composerVoiceStart.fueBody': 'With an empty message box, this button starts a live voice conversation with the agent.',
  'sessionOutline.fueTitle': 'Jump to any message',
  'sessionOutline.fueBody': 'Opens a list of every message in this conversation so you can jump straight to one.',
  'onboarding.tour.newSession.title': 'Start a new session',
  'onboarding.tour.newSession.body': 'Spin up a new coding session with any agent, in any project directory.',
  'onboarding.tour.browse.title': 'Browse your projects',
  'onboarding.tour.browse.body': 'Pick a repo or folder across your machines, then start a session right from there.',
  'onboarding.tour.settings.title': 'Settings',
  'onboarding.tour.settings.body': 'Language, appearance, voice, and machine preferences all live here — including this tour’s on/off switch.',
  'onboarding.tour.next': 'Next',
  'onboarding.tour.finish': 'Got it',
  ...
  'settings.general.agents.description': 'Hub-wide defaults for New Session create, resumed sessions, and peer spawn (MCP spawn_peer / hapi spawn-peer).',
  ...
  'settings.general.operatorDock.gateLabel': 'Operator gate secret',
  'settings.general.operatorDock.gateHint': 'Paste HAPI_INLINE_SECRET from hub.env. Quest cannot use the browser prompt reliably — use this field. Not the HAPI login / CLI token / JWT.',
  'settings.general.operatorDock.gateSubmit': 'Unlock',
  'settings.general.operatorDock.gateCancel': 'Cancel',
  ...
  'settings.onboarding.toggle.label': 'Show onboarding tips',
  'settings.onboarding.toggle.description': 'The first-visit shell tour and per-feature "new" dots. On by default.',
  ...
  'settings.display.pinInProgressSessions.desc': 'How loudly unpinned sessions float to the In progress section above project folders. Default is long-running jobs (outliving batch work with a session job meter). Quiet active agents stay in project folders unless you choose All activity. Global pins remain above it; project pins stay first inside their folders. Off keeps everything in directory groups.',
  ...
  'settings.display.blockedAlert': 'Blocker alerts',
  'settings.display.blockedAlert.desc': 'How loudly the session list announces an agent that just became blocked. The counter is always shown.',
  'settings.display.blockedAlert.count': 'Count only',
  'settings.display.blockedAlert.pulse': 'Pulse',
  'settings.display.blockedAlert.sound': 'Pulse + sound',
