export default {
  ...
  'runner.skew.banner.upgradeNeedsHandoff': 'This machine opted out of version handoff (soup/rebuild-only hub host). Rematerialize soup or clear HAPI_DISABLE_VERSION_HANDOFF, or use Restart. Ordinary fleet runners must not set this flag.',
