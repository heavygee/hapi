export default {
  ...
  'sessions.blockedChip.noResponse': 'No response',
  'sessions.blockedChip.agentError': 'Agent error',
  'sessions.blockedChip.hubInferred': 'Detected by HAPI, not reported by the agent',
