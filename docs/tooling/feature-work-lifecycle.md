...
[`operator-visible-proof`](../../../skills/operator-visible-proof/SKILL.md) —
inline into HAPI while developing, then `pr-attach-proof` at PR time. This
section is the HAPI product-workflow deep dive of the same contract.
