export default {
  ...
  'sessions.search.dictationProcessing': '正在转录…',
  ...
  'sessions.kitchenStatus.label': '厨房卫生需要注意',
  'sessions.blockedSection': '已阻塞',
  'sessions.blockedChip.blocked': '已阻塞',
  'session.action.markUnblocked': '标记为未阻塞…',
  'sessions.unblock.title': '标记为未阻塞',
  'sessions.unblock.description': '回复代理会把理由留在对话记录里；在这里直接忽略则不会，所以请填写原因——它会写入 overseer 读取的事件日志。',
  'sessions.unblock.reasonLabel': '解除阻塞原因',
  'sessions.unblock.placeholder': '为什么不再阻塞？',
  'sessions.unblock.reasonRequired': '必须填写原因。',
  'sessions.unblock.confirm': '标记为未阻塞',
  'sessions.unblock.preset.handled': '已在 HAPI 之外处理',
  'sessions.unblock.preset.notBlocked': '其实并未阻塞',
  'sessions.unblock.preset.abandoned': '放弃这项工作',
  'sessions.unblock.preset.superseded': '已被其他工作取代',
  'sessions.blockedChip.stalled': '已停滞',
  'sessions.blockedChip.permission': '需要权限',
  'sessions.blockedChip.decision': '需要决策',
  'sessions.blockedChip.review': '需要审阅',
  'sessions.blockedChip.failed': '失败',
  'sessions.blockedChip.question': '待回答',
  ...
  'session.time.weeksAgo': '{n} 周前',
  'session.time.monthsAgo': '{n} 个月前',
  'session.time.almostOneYearAgo': '差不多一年前',
  ...
  'session.log.filter.pinned': '已固定',
  'session.log.filterQuery': '筛选摘要',
  'session.log.filterQueryPlaceholder': '筛选摘要…',
  'session.log.emptyPinned': '尚无固定消息 — 在消息上使用固定按钮',
  'session.log.emptyFilter': '没有匹配此筛选的摘要',
  ...
  'newSession.type.worktree.desc': '在仓库旁创建新工作树，这样此会话就不会影响你的其他分支（Cursor 使用原生 ~/.cursor/worktrees）',
  ...
  'fue.dontShowAgain': '不再显示此类提示',
  'composerTerminal.fueTitle': '远程终端',
  'composerTerminal.fueBody': '在运行此会话的机器上打开实时终端——与通过 SSH 连接相同的 shell。',
  'composerSettings.fueTitle': '会话设置',
  'composerSettings.fueBody': '模型、努力程度、权限模式等仅针对此会话的选项都在这里。',
  'composerSwitchRemote.fueTitle': '切换到远程控制',
  'composerSwitchRemote.fueBody': '将此会话交给网页端接管，这样你可以在任意设备上继续——不只是这个终端。',
  'composerSchedule.fueTitle': '安排稍后发送',
  'composerSchedule.fueBody': '选择一个时间，HAPI 会替你发送这条消息——适合非工作时间的提醒或批量处理任务。',
  'composerVoiceStart.fueTitle': '说话代替打字',
  'composerVoiceStart.fueBody': '当消息框为空时，此按钮会开始与智能体的实时语音对话。',
  'sessionOutline.fueTitle': '跳转到任意消息',
  'sessionOutline.fueBody': '打开此对话中所有消息的列表，方便你直接跳转到某一条。',
  'onboarding.tour.newSession.title': '创建新会话',
  'onboarding.tour.newSession.body': '在任意项目目录中，用任意智能体启动一个新的编码会话。',
  'onboarding.tour.browse.title': '浏览你的项目',
  'onboarding.tour.browse.body': '在你的机器上选择一个仓库或文件夹，然后直接从这里启动会话。',
  'onboarding.tour.settings.title': '设置',
  'onboarding.tour.settings.body': '语言、外观、语音和机器偏好都在这里——包括这个引导的开关。',
  'onboarding.tour.next': '下一步',
  'onboarding.tour.finish': '知道了',
  ...
  'settings.general.agents.description': '新建会话、恢复会话与对等 spawn（MCP spawn_peer / hapi spawn-peer）共用的中心级默认值。',
  ...
  'settings.general.operatorDock.gateLabel': '操作员闸门密钥',
  'settings.general.operatorDock.gateHint': '粘贴 hub.env 中的 HAPI_INLINE_SECRET。Quest 浏览器原生对话框不可靠 — 请用此输入框。不是 HAPI 登录 / CLI token / JWT。',
  'settings.general.operatorDock.gateSubmit': '解锁',
  'settings.general.operatorDock.gateCancel': '取消',
  ...
  'settings.onboarding.title': '引导',
  'settings.onboarding.toggle.label': '显示引导提示',
  'settings.onboarding.toggle.description': '首次访问的应用引导和各功能的"新"角标。默认开启。',
  ...
  'settings.display.pinInProgressSessions.desc': '未置顶会话浮到「进行中」分区（位于项目目录分组之上）的程度。默认为长时间任务（带会话 job 进度的后台批处理）。安静的活跃智能体仍留在项目目录中，除非选择「全部活动」。全局置顶仍在该分区之上；项目置顶只在各自项目分组内靠前。关闭后全部保留在目录分组中。',
  ...
  'settings.display.blockedAlert': '阻塞提醒',
  'settings.display.blockedAlert.desc': '会话列表如何提示刚刚被阻塞的代理。计数始终显示。',
  'settings.display.blockedAlert.count': '仅计数',
  'settings.display.blockedAlert.pulse': '闪烁',
  'settings.display.blockedAlert.sound': '闪烁 + 声音',
