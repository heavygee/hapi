...
export async function startHappyServer(client: ApiSessionClient, options: StartHappyServerOptions = {}) {
    ...
    const toolNames = enableChangeTitle
        ? ['change_title', 'display_image', 'display_video', 'display_media', 'display_links', 'list_peers', 'ping_peer', 'inspect_peer', 'spawn_peer', SESSION_JOB_TOOL_NAME]
        : ['display_image', 'display_video', 'display_media', 'display_links', 'list_peers', 'ping_peer', 'inspect_peer', 'spawn_peer', SESSION_JOB_TOOL_NAME];
