...
export function SessionList(props: {
    ...
    const visibleSessions = useMemo(
        ...
        [allSessions, hasTextQuery, isSearchFiltering, normalizedQuery, searchScoreIndex, timeScopedSessions, machineLabelsById] // eslint-disable-line react-hooks/exhaustive-deps
    )
